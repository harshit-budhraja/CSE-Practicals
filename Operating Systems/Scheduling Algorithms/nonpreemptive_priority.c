/*
* -----------------------------------------------------*
* To implement non-preemptive priority scheduling algorithm
...
* P[5] > P[1].
*
* Sample Input Answer:- 10.5 seconds and 7.66 seconds
*
* Author:- Harshit Budhraja
* Date:- 04/04/2017 19:12hrs IST
*/
...
int main(void)
{
	...
	while(time<=endtime)
	{
		...
		while(P[selected].runtime < P[selected].cpu_burst)
		{
			P[selected].runtime++;
			time++;
		}
